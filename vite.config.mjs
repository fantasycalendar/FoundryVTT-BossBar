...
// ATTENTION!
// You must change `base` and the `proxy` strings replacing `/modules/bossbar/` with your
// module or system ID.
...
export default () =>
{
    ...
    return {
        ...
        base: '/modules/bossbar/',   // Base module path that 30001 / served dev directory.
        ...
        server: {
            ...
            open: '/game',
            proxy: {
                '^(/modules/bossbar/languages)': 'http://localhost:30000',
                '^(?!/modules/bossbar/)': 'http://localhost:30000',
